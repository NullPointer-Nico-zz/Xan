...
class HelpCommand(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        help_commands_category.set_author(
            name=ctx.author.name, icon_url=ctx.author.avatar_url_as(size=512))
        help_commands_category.set_thumbnail(
            url='https://i.ibb.co/5Bt2bM9/Neon-Photo-Editor-20200706-144711323.jpg')
        help_commands_category.add_field(
            name='**Kategorien**', value='**-----------------------------------------------**')
        help_commands_category.add_field(
            name='**All**', value=f'```» {len(commandcounter.alle_commands)} Commands```', inline=False)
        help_commands_category.add_field(
            name='**Everyone**', value=f'```» {len(commandcounter.Allegemeine_commands)} Commands```', inline=False)
        help_commands_category.add_field(
            name='**Fun**', value=f'```» {len(commandcounter.fun_commands)} Commands```')
        help_commands_category.add_field(
            name='**Moderation**', value=f'```» {len(commandcounter.mod_commands)} Commands```', inline=False)
        help_commands_category.add_field(
            name='**Administrator**', value=f'```» {len(commandcounter.Admin_Commands)} Commands```', inline=False)
        help_commands_category.add_field(
            name='**Owner**', value=f'```» {len(commandcounter.owner_commands)} Commands```', inline=False)
        help_commands_category.set_footer(
            text=f'Command angefordert von {ctx.message.author.name}')
    ...
    async def fun(self, ctx):
        help_commands_fun = discord.Embed(
            title='**Help Fun**', description=f'Settings | Help', color=discord.Color.dark_blue())
    ...
    async def all(self, ctx):
        # alle commands
        help_commands_all = discord.Embed(
            title='**Help All**', description='Settings | Help', color=discord.Color.dark_blue())
        help_commands_all.set_author(
            name=ctx.author.name, icon_url=ctx.author.avatar_url_as(size=512))
        help_commands_all.set_thumbnail(
            url='https://i.ibb.co/5Bt2bM9/Neon-Photo-Editor-20200706-144711323.jpg')
        help_commands_all.add_field(
            name='**Botinfo**', value=f'_usage: {self.client.get_prefix}botinfo_', inline=False)
        help_commands_all.add_field(
        ...
        help_commands_all.add_field(
            name='**Broadcast**', value='_usage: br <text>_', inline=False)
        help_commands_all.add_field(
        ...
        help_commands_all.add_field(
            name='**Unicode**', value='_usage: unicode <emoji>_', inline=False)
    ...
    async def everyone(self, ctx):
        ...
        help_command_for_all = discord.Embed(
            title='**Help Everyone**', description='Settings | Help', color=discord.Color.dark_blue())
    ...
    async def moderation(self, ctx):
        ...
        help_command_mod = discord.Embed(
            title='**Help Moderation**', description='Setting | Help', color=discord.Color.dark_blue())
    ...
    async def administrator(self, ctx):
        ...
        adminstrator = discord.Embed(
            title='**Help Administrator**', description='Settings | Help', color=discord.Color.dark_blue())
    ...
    async def owner(self, ctx):
        # owner commands
        owner = discord.Embed(
            title='**Help Owner**', description='Settings | Help', color=discord.Color.dark_blue())
        owner.set_thumbnail(
            url='https://i.ibb.co/5Bt2bM9/Neon-Photo-Editor-20200706-144711323.jpg')
